      ...
      {posts.length === 0 ? (
        ...
        posts.map((post) => {
          ...
          return (
            ...
            >
              <div
                className={`border border-gray-700 min-h-[110px] py-5 px-5 rounded-xl shadow-xl bg-gradient-to-r from-gray-700 to-gray-800 transition-all duration-300 flex justify-between items-start gap-4 transform
